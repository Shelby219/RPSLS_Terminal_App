      ...
      while @player_score <  @winning_score && @computer_score <  @winning_score
        ...
        when :COMPUTERWIN 
         ...
         if @player_score == @winning_score 
            puts "CONGRATULATIONS! #{@@name} is the ULTIMATE RPSSL CHAMPION!".colorize(:green)
            break
         elsif @computer_score == @winning_score 
            puts "Too bad, the computer remains the ULTIMATE RPSSL CHAMPION!".colorize(:red) #doubles up at the moment
            break
         else
            puts "NEXT ROUND!\n\n"
